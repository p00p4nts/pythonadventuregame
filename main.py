...
class Character:
    def __init__(self, name, health, strength, inventory=None):
        ...
        if battle(player, monster):
            ...
            if choice == "1":
                ...
                if choice == "1":
                    ...
                    slow_print(f"\n{player.name} lives peacefully in the village. The adventure ends here.", 0.07)

            # Game over, successful or not
        else:
            slow_print("\nYour adventure ends here. Better luck next time!", 0.07)
